...
Weightmaps can get mixed up if not selected''',
            ...
            ('*', 'Export tangent and binormal.\nFor characters, armors, etc') : 'Export tangent and binormal.\nFor characters, armors, etc',
            ('*', 'tangent & binormal & sign') : 'tangent & binormal & sign',
            ('*', 'Export tangent and binormal\'s signs and binormal (before multiplying by sign).\nCompatible with most shaders') : 'Export tangent and binormal\'s signs and binormal (before multiplying by sign).\nCompatible with most shaders',
            ('*', 'tangent & sign') : 'tangent & sign',
            ('*', 'Export tangent and binormal\'s signs.\nCompute the binormals at runtime.\nFor weapons, buildings, etc') : 'Export tangent and binormal\'s signs.\nCompute the binormals at runtime.\nFor weapons, buildings, etc',
            ('*', 'no tangent') : 'no tangent',
            ('*', 'Select if there is no UV map') : 'Select if there is no UV map',
            ('*', 'tangent & binormal(flip) & sign(flip)') : 'tangent & binormal(flip) & sign(flip)',
            ('*', 'For armors, robot limbs, backpacks.\nIcon and not equipped shaders will also be correctly oriented Binormal') : 'For armors, robot limbs, backpacks.\nIcon and not equipped shaders will also be correctly oriented Binormal',
            ('*', 'zero vector') : 'zero vector',
            ('*', 'For unloaded interiors') : 'For unloaded interiors',
            ...
            ('*', 'Parent') : 'Parent',
            ('*', 'Export objects relative to own parent') : 'Export objects relative to own parent',
...
選択されていないと、ウェイトマップが混同される可能性があります''',
            ...
            ('*', 'Export tangent and binormal.\nFor characters, armors, etc') : '接線と従法線をエクスポートします\nキャラクターや防具等',
            ('*', 'tangent & binormal & sign') : '接線と従法線と符号',
            ('*', 'Export tangent and binormal\'s signs and binormal (before multiplying by sign).\nCompatible with most shaders') : '接線と従法線の符号と従法線(符号乗算前)をエクスポートします\nほとんどのシェーダーと互換性があります',
            ('*', 'tangent & sign') : '接線と符号',
            ('*', 'Export tangent and binormal\'s signs.\nCompute the binormals at runtime.\nFor weapons, buildings, etc') : '接線と従法線の符号をエクスポートします\n実行時に従法線を計算します\n武器や建物等',
            ('*', 'no tangent') : '接線なし',
            ('*', 'Select if there is no UV map') : 'UVマップがない場合に選択します',
            ('*', 'tangent & binormal(flip) & sign(flip)') : '接線と従法線(反転)と符号(反転)',
            ('*', 'For armors, robot limbs, backpacks.\nIcon and not equipped shaders will also be correctly oriented Binormal') : '防具,義肢,バックパック用\nアイコン及び非装備のシェーダーもBinormalの方向が正しくなります。',
            ('*', 'zero vector') : '零ベクトル',
            ('*', 'For unloaded interiors') : 'アンロード時の内装用',
            ...
            ('*', 'Parent') : 'ペアレント',
            ('*', 'Export objects relative to parent') : 'ペアレントを基準にオブジェクトをエクスポートします',
