...
bl_info = {
    ...
    "warning": "",
    "doc_url": "https://github.com/Lucius64/kenshi_io_tools",
...
def register():
    ...
    TOPBAR_MT_file_import.append(menu_func_import_skeleton)
    TOPBAR_MT_file_export.append(menu_func_export_skeleton)
    TOPBAR_MT_file_import.append(menu_func_import_collision)
    TOPBAR_MT_file_export.append(menu_func_export_collision)
...
def unregister():
    ...
    TOPBAR_MT_file_import.remove(menu_func_import_skeleton)
    TOPBAR_MT_file_export.remove(menu_func_export_skeleton)
    TOPBAR_MT_file_import.remove(menu_func_import_collision)
    TOPBAR_MT_file_export.remove(menu_func_export_collision)
